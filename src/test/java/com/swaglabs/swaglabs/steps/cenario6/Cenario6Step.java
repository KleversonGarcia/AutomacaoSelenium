package com.swaglabs.swaglabs.steps.cenario6;
...
public class Cenario6Step extends ParentSteps {


  private HomePage homePage;


  @Dado("^usuario faz o login com o username: \"([^\"]*)\" e password: \"([^\"]*)\"$")
  ...
  public void validaSeOsValoresDoCarrinhoEstaCorreto() throws InterruptedException {
    ...
    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='last-name']"))).sendKeys("potter");
    ...
    boolean tks = wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[text() = 'Thank you for your order!']")));
